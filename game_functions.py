...
def get_number_aliens_x(ai_settings, alien_width):
    '''计算每行可以容纳多少个外星人'''
    available_space_x = ai_settings.screen_width - 8 * alien_width
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    nubmer_rows = get_number_rows(ai_settings, ship.rect.height, alien.rect.height)
    # 创建第一行外星人
    for row_number in range(nubmer_rows):
